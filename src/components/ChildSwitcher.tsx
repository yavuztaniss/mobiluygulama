...
function createStyles(colors: AppColors) {
  return StyleSheet.create({
    ...
    pillName: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.md, color: colors.textMuted },
    pillNameActive: { color: colors.textBright },
    pillBrans: { fontFamily: fontFamily.manropeSemi, fontSize: 11, color: colors.textDim },
    addPill: {
      width: 48, borderRadius: 18, borderWidth: 1.5, borderStyle: 'dashed', borderColor: colors.border,
      alignItems: 'center', justifyContent: 'center',
    },
    addPillText: { color: colors.textDim, fontSize: 20 },
