...
function createStyles(colors: AppColors) {
  ...
  programLabel: { fontFamily: fontFamily.mono, fontSize: 10, fontWeight: '800', letterSpacing: 1.5, color: colors.textFaint },
  programCount: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.sm, color: colors.textFaint },
  doneRow: { flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: radius.xxl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.accentBorder, padding: spacing.md },
  doneIcon: { width: 44, height: 44, borderRadius: 15, backgroundColor: colors.accentTint, alignItems: 'center', justifyContent: 'center' },
  doneTitle: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  ...
  donePill: { backgroundColor: colors.accentTint, paddingVertical: 4, paddingHorizontal: 9, borderRadius: radius.pill },
  donePillText: { fontFamily: fontFamily.manropeExtra, fontSize: 11, color: colors.accent },
  nowCard: { borderRadius: radius.xxl, backgroundColor: colors.navySurfaceAlt, borderWidth: 1, borderColor: colors.navyBorderSoft, padding: spacing.lg },
  ...
  techPill: { backgroundColor: colors.accentTint, paddingVertical: 5, paddingHorizontal: 10, borderRadius: radius.pill },
  techPillText: { fontFamily: fontFamily.manropeBold, fontSize: 11, color: colors.accent },
  nowTitle: { fontFamily: fontFamily.archivoBold, fontSize: 22, color: colors.white, marginTop: 10 },
  nowTimeRow: { flexDirection: 'row', alignItems: 'baseline', marginTop: 4 },
  nowTime1: { fontFamily: fontFamily.archivoBold, fontSize: 32, color: colors.white },
  nowTime2: { fontFamily: fontFamily.archivoSemi, fontSize: fontSize.lg, color: colors.textMuted },
  nowVenue: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.base, color: colors.iconMuted, marginTop: 6 },
  ...
  nowSporcuCount: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  ...
  yoklamaBtnText: { fontFamily: fontFamily.manropeExtra, fontSize: fontSize.sm, color: colors.accentOnDark },
  upcomingRow: { flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: radius.xxl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, padding: spacing.md },
  upcomingIcon: { width: 44, height: 44, borderRadius: 15, backgroundColor: colors.navyChip, alignItems: 'center', justifyContent: 'center' },
  upcomingTitle: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  upcomingSub: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 1 },
  upcomingPill: { backgroundColor: 'rgba(255,255,255,0.06)', paddingVertical: 4, paddingHorizontal: 9, borderRadius: radius.pill },
  upcomingPillText: { fontFamily: fontFamily.manropeExtra, fontSize: 11, color: colors.textMuted },
  footerNote: { textAlign: 'center', fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textFaint, marginTop: spacing.xs },
  ...
  quickActionText: { fontFamily: fontFamily.manropeBold, fontSize: 12.5, color: colors.iconMuted, textAlign: 'center' },
  bireyselCard: { flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: radius.xxl, backgroundColor: colors.navySurfaceAlt, borderWidth: 1, borderColor: colors.accentBorder, padding: spacing.md, marginTop: spacing.sm },
