...
function getDurakRenk(colors: AppColors): Record<string, { dot: string; text: string; line: string }> {
  return {
    ...
    suan: { dot: colors.accent, text: colors.accent, line: colors.navyBorderStrong },
    bekliyor: { dot: colors.navyChip, text: colors.textMuted, line: colors.navyBorderStrong },
  };
}
...
function createStyles(colors: AppColors) {
  ...
  headerTitle: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.md, color: colors.white },
  headerSub: { fontFamily: fontFamily.manropeMedium, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 2 },
  liveBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingVertical: 6, paddingHorizontal: 10, borderRadius: radius.pill, backgroundColor: colors.accentTint },
  ...
  mapBox: { height: 150, borderRadius: radius.xxl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorderSoft, alignItems: 'center', justifyContent: 'center', gap: 8, position: 'relative' },
  ...
  mapBadge: { position: 'absolute', top: 10, right: 10, backgroundColor: 'rgba(8,17,33,0.8)', paddingVertical: 5, paddingHorizontal: 9, borderRadius: radius.pill },
  mapBadgeText: { fontFamily: fontFamily.manropeExtra, fontSize: 9.5, color: colors.iconMuted },
  soforRow: { flexDirection: 'row', alignItems: 'center', gap: 11, borderRadius: radius.xl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, padding: 13 },
  soforAvatar: { width: 42, height: 42, borderRadius: 14, backgroundColor: colors.navyChip, alignItems: 'center', justifyContent: 'center' },
  soforAvatarText: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.sm, color: colors.iconMuted },
  soforName: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.md, color: colors.white },
  soforSub: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 1 },
  callBtn: { width: 40, height: 40, borderRadius: 13, backgroundColor: colors.accentTint, borderWidth: 1, borderColor: colors.accentBorder, alignItems: 'center', justifyContent: 'center' },
  sectionLabel: { fontFamily: fontFamily.mono, fontSize: 10, fontWeight: '800', letterSpacing: 1.5, color: colors.textFaint, marginBottom: spacing.sm },
  durakRow: { flexDirection: 'row', gap: 12 },
  durakDotCol: { width: 14, alignItems: 'center' },
  durakDot: { width: 14, height: 14, borderRadius: 7, borderWidth: 2, borderColor: 'rgba(255,255,255,0.15)' },
  ...
  durakTag: { backgroundColor: colors.accentTint, paddingVertical: 2, paddingHorizontal: 7, borderRadius: radius.pill },
  durakTagText: { fontFamily: fontFamily.manropeExtra, fontSize: 9.5, color: colors.accent },
  sporcuRow: { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: radius.xl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, padding: spacing.md },
  sporcuRowTitle: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  ...
  notifyBtn: { height: 48, borderRadius: 14, backgroundColor: colors.accentTint, borderWidth: 1, borderColor: colors.accentBorder, alignItems: 'center', justifyContent: 'center' },
  ...
  durakGroupLabel: { fontFamily: fontFamily.mono, fontSize: 9.5, fontWeight: '800', letterSpacing: 1.2, color: colors.textFaint, marginBottom: 6, marginTop: spacing.xs },
  sporcuListRow: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 14, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, padding: 10, marginTop: 6 },
  sporcuAvatar: { width: 38, height: 38, borderRadius: 13, backgroundColor: colors.navyChip, alignItems: 'center', justifyContent: 'center' },
  sporcuAvatarText: { fontFamily: fontFamily.archivoBold, fontSize: 12, color: colors.iconMuted },
  sporcuListName: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.sm, color: colors.white },
  sporcuListVeli: { fontFamily: fontFamily.manropeSemi, fontSize: 10.5, color: colors.textMuted, marginTop: 1 },
  callBtnSm: { width: 34, height: 34, borderRadius: 11, backgroundColor: colors.accentTint, borderWidth: 1, borderColor: colors.accentBorder, alignItems: 'center', justifyContent: 'center' },
  });
}
