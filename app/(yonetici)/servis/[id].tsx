        ...
        {!loading && !error && rota && (
          <ScrollView contentContainerStyle={styles.scroll}>
            ...
            <View style={styles.soforRow}>
              ...
              <View style={{ flex: 1, minWidth: 0 }}>
                <Text style={styles.soforName} numberOfLines={1}>{rota.sofor}</Text>
                  ...
                  <View key={d.id} style={styles.durakRow}>
                    ...
                    <View style={styles.durakMid}>
                      <View style={styles.durakTopRow}>
                        <Text style={[styles.durakAd, { color: renk.text }]} numberOfLines={1}>{d.ad}</Text>
            ...
            <Pressable style={styles.sporcuRow} onPress={() => setSporcuListOpen(true)}>
              ...
              <Text style={styles.sporcuRowSub} numberOfLines={1}>{rota.sporcuSayisi} sporcu · {rota.duraklar.length} durakta biniş</Text>
                  ...
                  <View key={d.id} style={{ marginBottom: spacing.sm }}>
                    ...
                    {grup.map((s) => (
                      <View key={s.id} style={styles.sporcuListRow}>
                        ...
                        <View style={{ flex: 1, minWidth: 0 }}>
                          <Text style={styles.sporcuListName} numberOfLines={1}>{s.ad}</Text>
                          <Text style={styles.sporcuListVeli} numberOfLines={1}>{s.veliAd} · {s.veliTelefon}</Text>
                        </View>
                        <Pressable
                          hitSlop={10}
...
function createStyles(colors: AppColors) {
  ...
  mapBadgeText: { fontFamily: fontFamily.manropeExtra, fontSize: fontSize.micro, color: colors.textMuted },
  ...
  soforSub: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, lineHeight: lineHeightFor(fontSize.sm), color: colors.textMuted, marginTop: 1 },
  ...
  sectionLabel: { fontFamily: fontFamily.mono, fontSize: fontSize.xs, fontWeight: '800', letterSpacing: 1.5, color: colors.textDim, marginBottom: spacing.sm },
  ...
  durakAd: { flex: 1, minWidth: 0, fontFamily: fontFamily.manropeExtra, fontSize: fontSize.md },
  ...
  durakSub: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, lineHeight: lineHeightFor(fontSize.sm), color: colors.textMuted },
  durakTag: { backgroundColor: colors.accentSoft, paddingVertical: 2, paddingHorizontal: 7, borderRadius: radius.pill },
  durakTagText: { fontFamily: fontFamily.manropeExtra, fontSize: fontSize.micro, color: colors.accent },
  ...
  sporcuRowSub: { flex: 1, fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, lineHeight: lineHeightFor(fontSize.sm), color: colors.textMuted },
  ...
  durakGroupLabel: { fontFamily: fontFamily.mono, fontSize: fontSize.xs, fontWeight: '800', letterSpacing: 1.2, color: colors.textDim, marginBottom: 6, marginTop: spacing.xs },
  ...
  sporcuListVeli: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 1 },
