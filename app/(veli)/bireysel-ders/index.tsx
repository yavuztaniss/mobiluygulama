...
function createStyles(colors: AppColors) {
  ...
  infoBtn: { width: 40, height: 40, borderRadius: 13, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorderSoft, alignItems: 'center', justifyContent: 'center' },
  infoIcon: { color: colors.iconMuted, fontSize: 16 },
  ...
  filtreChip: { paddingVertical: 9, paddingHorizontal: 15, borderRadius: radius.pill, backgroundColor: colors.navySurface, borderWidth: 1.5, borderColor: colors.navyBorder },
  filtreChipActive: { backgroundColor: colors.accentTint, borderColor: colors.accentBorder },
  ...
  promoBanner: { flexDirection: 'row', alignItems: 'center', gap: 9, borderRadius: 14, backgroundColor: colors.accentTint, borderWidth: 1, borderColor: 'rgba(46,230,168,0.16)', padding: 12 },
  ...
  listCount: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.sm, color: colors.textFaint },
  card: { borderRadius: radius.xxl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, padding: spacing.md },
  ...
  musaitDot: { position: 'absolute', bottom: -3, right: -3, width: 16, height: 16, borderRadius: 8, backgroundColor: colors.accent, borderWidth: 3, borderColor: colors.navySurface },
  nameRow: { flexDirection: 'row', alignItems: 'center', gap: 8, flexWrap: 'wrap' },
  name: { fontFamily: fontFamily.manropeExtra, fontSize: fontSize.lg, color: colors.white },
  musaitPill: { backgroundColor: colors.accentTint, paddingVertical: 3, paddingHorizontal: 8, borderRadius: radius.pill },
  musaitPillText: { fontFamily: fontFamily.manropeExtra, fontSize: 9.5, letterSpacing: 0.4, color: colors.accent },
  doluPill: { backgroundColor: 'rgba(255,255,255,0.06)', paddingVertical: 3, paddingHorizontal: 8, borderRadius: radius.pill },
  ...
  chevron: { color: colors.textFaint, fontSize: 16, marginTop: 4 },
  ...
  priceBoxAccent: { flex: 1, borderRadius: 13, backgroundColor: 'rgba(46,230,168,0.07)', borderWidth: 1, borderColor: 'rgba(46,230,168,0.22)', padding: 11, position: 'relative' },
  ...
  footerNote: { textAlign: 'center', fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textFaint, marginTop: spacing.sm, lineHeight: 17 },
  });
}
