          ...
          {!loading && !error && ozet && (
            <>
              ...
              <Pressable style={styles.attendanceRow} onPress={() => router.push('/yoklama')}>
                <View style={[styles.attendanceIcon, { backgroundColor: ozet.sonYoklama.katildi ? colors.accentTint : colors.dangerBg }]}>
...
function createStyles(colors: AppColors) {
  ...
  bellBtn: { width: 44, height: 44, borderRadius: 15, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorderSoft, alignItems: 'center', justifyContent: 'center' },
  bellIcon: { fontSize: 18 },
  bellDot: { position: 'absolute', top: -4, right: -4, minWidth: 18, height: 18, borderRadius: 9, backgroundColor: colors.accent, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: colors.navyBg, paddingHorizontal: 3 },
  bellDotText: { fontFamily: fontFamily.manropeExtra, fontSize: 10.5, color: colors.accentOnDark },
  trainingCard: { backgroundColor: colors.navySurfaceAlt },
  ...
  branchPill: { backgroundColor: colors.accentTint, paddingVertical: 5, paddingHorizontal: 10, borderRadius: radius.pill },
  branchPillText: { fontFamily: fontFamily.manropeExtra, fontSize: 11, color: colors.accent },
  trainingTitle: { fontFamily: fontFamily.archivoBold, fontSize: 22, color: colors.white, marginTop: 10 },
  trainingTimeRow: { flexDirection: 'row', alignItems: 'baseline', marginTop: 4 },
  trainingTime1: { fontFamily: fontFamily.archivoBold, fontSize: 32, color: colors.white },
  trainingTime2: { fontFamily: fontFamily.archivoSemi, fontSize: fontSize.lg, color: colors.textMuted },
  trainingVenue: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.base, color: colors.iconMuted, marginTop: 6 },
  ...
  coachAvatar: { width: 40, height: 40, borderRadius: 14, backgroundColor: '#1D3560', alignItems: 'center', justifyContent: 'center' },
  coachAvatarText: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.sm, color: '#9FE8CE' },
  coachMid: { flex: 1, minWidth: 0 },
  coachName: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  ...
  emptyTraining: { borderRadius: radius.xxl, borderWidth: 1.5, borderStyle: 'dashed', borderColor: colors.navyBorderStrong, backgroundColor: colors.navySheet, padding: spacing.lg, flexDirection: 'row', alignItems: 'center', gap: spacing.md },
  emptyTrainingIcon: { fontSize: 22 },
  emptyTrainingTitle: { fontFamily: fontFamily.archivoSemi, fontSize: fontSize.md, color: colors.white },
  emptyTrainingSub: { fontFamily: fontFamily.manropeMedium, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 3 },
  attendanceRow: { flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: radius.xxl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, padding: spacing.md },
  attendanceIcon: { width: 44, height: 44, borderRadius: 15, alignItems: 'center', justifyContent: 'center' },
  attendanceMid: { flex: 1, minWidth: 0 },
  attendanceLabel: { fontFamily: fontFamily.mono, fontSize: 10, fontWeight: '800', letterSpacing: 1.5, color: colors.textFaint },
  attendanceTitle: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white, marginTop: 2 },
  attendanceSub: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 1 },
  attendancePct: { backgroundColor: colors.accentTint, paddingVertical: 4, paddingHorizontal: 9, borderRadius: radius.pill },
  attendancePctText: { fontFamily: fontFamily.manropeExtra, fontSize: 11, color: colors.accent },
  aidatCard: { borderRadius: radius.xxl, borderWidth: 1, borderColor: 'rgba(255,180,84,0.4)', backgroundColor: colors.navySurfaceAlt, padding: spacing.lg },
  aidatCardGecikti: { borderColor: colors.dangerBorder },
  aidatTop: { flexDirection: 'row', alignItems: 'center', gap: 13 },
  aidatIcon: { width: 44, height: 44, borderRadius: 15, backgroundColor: 'rgba(255,255,255,0.06)', alignItems: 'center', justifyContent: 'center' },
  ...
  aidatAmount: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.xxl, color: colors.white },
  aidatPill: { backgroundColor: 'rgba(255,180,84,0.14)', paddingVertical: 4, paddingHorizontal: 9, borderRadius: radius.pill },
  ...
  aidatNoteDanger: { color: colors.dangerSoft },
  aidatOkRow: { flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: radius.xxl, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.accentBorder, padding: spacing.md },
  aidatOkIcon: { width: 44, height: 44, borderRadius: 15, backgroundColor: colors.accentTint, alignItems: 'center', justifyContent: 'center' },
  aidatOkTitle: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  ...
  bireyselCard: { flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: radius.xxl, backgroundColor: colors.navySurfaceAlt, borderWidth: 1, borderColor: colors.accentBorder, padding: spacing.md },
  bireyselIcon: { width: 44, height: 44, borderRadius: 15, backgroundColor: colors.accentTint, alignItems: 'center', justifyContent: 'center' },
  bireyselTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  bireyselTitle: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  yeniPill: { backgroundColor: colors.accent, paddingVertical: 2, paddingHorizontal: 7, borderRadius: radius.pill },
  yeniPillText: { fontFamily: fontFamily.manropeExtra, fontSize: 9, letterSpacing: 0.5, color: colors.accentOnDark },
  ...
  quickActionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, height: 48, borderRadius: 15, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorderSoft },
  quickActionIcon: { fontSize: 16 },
  quickActionText: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.sm, color: colors.iconMuted },
  duyuruHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: spacing.sm },
  duyuruTitle: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.lg, color: colors.white },
  duyuruAll: { fontFamily: fontFamily.manropeExtra, fontSize: fontSize.base, color: colors.accent },
  duyuruRow: { flexDirection: 'row', gap: 13, alignItems: 'flex-start', paddingVertical: spacing.sm, borderBottomWidth: 1, borderBottomColor: colors.navyBorder },
  duyuruIcon: { width: 44, height: 44, borderRadius: 15, backgroundColor: colors.accentTint, alignItems: 'center', justifyContent: 'center' },
  duyuruBaslik: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  duyuruAciklama: { fontFamily: fontFamily.manropeMedium, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 2, lineHeight: 18 },
  duyuruZaman: { fontFamily: fontFamily.manropeSemi, fontSize: 11, color: colors.textFaint },
  });
}
