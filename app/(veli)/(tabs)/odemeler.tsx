...
function createStyles(colors: AppColors) {
  ...
  dueCard: { borderRadius: radius.xxl, borderWidth: 1, borderColor: 'rgba(255,180,84,0.4)', backgroundColor: colors.navySurfaceAlt, padding: spacing.xl },
  dueCardGecikti: { borderColor: colors.dangerBorder },
  ...
  duePill: { backgroundColor: 'rgba(255,180,84,0.14)', paddingVertical: 5, paddingHorizontal: 10, borderRadius: radius.pill },
  duePillText: { fontFamily: fontFamily.manropeExtra, fontSize: 10.5, color: colors.warning },
  dueAmount: { fontFamily: fontFamily.archivoBold, fontSize: 44, color: colors.white, letterSpacing: -1.5, marginTop: 12 },
  dueNote: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.base, color: colors.textMuted, marginTop: 2 },
  infoBox: { marginTop: spacing.md, borderRadius: 14, backgroundColor: colors.accentTint, borderWidth: 1, borderColor: 'rgba(46,230,168,0.18)', padding: 12 },
  infoBoxDanger: { backgroundColor: colors.dangerBg, borderColor: colors.dangerBorder },
  infoText: { fontFamily: fontFamily.manropeMedium, fontSize: fontSize.sm, color: colors.accent, lineHeight: 19 },
  infoTextDanger: { color: colors.dangerSoft },
  paidCard: { borderRadius: radius.xxl, borderWidth: 1, borderColor: colors.accentBorder, backgroundColor: colors.navySurfaceAlt, padding: spacing.xl, alignItems: 'center' },
  paidIcon: { width: 56, height: 56, borderRadius: 20, backgroundColor: colors.accentTint, alignItems: 'center', justifyContent: 'center' },
  paidTitle: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.lg, color: colors.white, marginTop: spacing.sm },
  paidSub: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 3 },
  paidNext: { fontFamily: fontFamily.manropeSemi, fontSize: 11, color: colors.textFaint, marginTop: spacing.sm },
  quickRow: { flexDirection: 'row', gap: spacing.sm },
  quickCard: { flex: 1, borderRadius: 18, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, padding: 13 },
  quickTitle: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  ...
  historyTitle: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.lg, color: colors.white },
  historyNote: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textFaint },
  historyRow: { flexDirection: 'row', alignItems: 'center', gap: 13, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: colors.navyBorder },
  historyIcon: { width: 42, height: 42, borderRadius: 14, backgroundColor: colors.accentTint, alignItems: 'center', justifyContent: 'center' },
  historyTitle2: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.base, color: colors.white },
  historySub: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 1 },
  historyAmount: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.md, color: colors.white },
  historyReceipt: { fontFamily: fontFamily.manropeExtra, fontSize: 10.5, color: colors.accent, marginTop: 1 },
  receiptBackdrop: { flex: 1, backgroundColor: 'rgba(4,10,20,0.62)', justifyContent: 'flex-end' },
  receiptSheet: { backgroundColor: colors.navySheet, borderTopLeftRadius: 28, borderTopRightRadius: 28, borderWidth: 1, borderColor: colors.navyBorderStrong, padding: spacing.lg },
  ...
  receiptIcon: { width: 44, height: 44, borderRadius: 15, backgroundColor: colors.accentTint, alignItems: 'center', justifyContent: 'center' },
  receiptTitle: { fontFamily: fontFamily.archivoBold, fontSize: fontSize.lg, color: colors.white },
  receiptNo: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted, marginTop: 1 },
  receiptOkBadge: { backgroundColor: colors.accentTint, paddingVertical: 5, paddingHorizontal: 9, borderRadius: radius.pill },
  receiptOkText: { fontFamily: fontFamily.manropeExtra, fontSize: 10, color: colors.accent },
  receiptTable: { borderRadius: 16, backgroundColor: colors.navySurface, borderWidth: 1, borderColor: colors.navyBorder, paddingHorizontal: 14, marginTop: spacing.md },
  receiptRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: colors.navyBorder },
  receiptRowLabel: { fontFamily: fontFamily.manropeSemi, fontSize: fontSize.sm, color: colors.textMuted },
  receiptRowValue: { fontFamily: fontFamily.manropeBold, fontSize: fontSize.sm, color: colors.white },
